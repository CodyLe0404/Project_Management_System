...
<template>
    <div class="flex items-center justify-center min-h-[calc(100vh-4rem)]">
        <div class="text-center">
            <h1 class="text-9xl font-bold text-surface-200 dark:text-surface-700">404</h1>
            <h2 class="text-2xl font-bold mt-4 mb-2 text-surface-900 dark:text-surface-0">Page Not Found</h2>
